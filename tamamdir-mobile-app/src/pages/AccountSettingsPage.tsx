        ...
        {verified ? (
          <div className="bg-primary/5 rounded-2xl border border-primary/20 p-5">
            ...
            <p className="text-xs text-on-surface-variant">
              <span className="font-bold">{user?.email}</span> adresiyle giriş yaparak İYTE öğrenci rozeti aldınız.
            </p>
          </div>
        ) : (
          <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant/20 p-5 space-y-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              {iyteEmailError && <p className="text-error text-xs">{iyteEmailError}</p>}
              <p className="text-[11px] text-outline">Kabul edilen uzantılar: @std.iyte.edu.tr · @iyte.edu.tr</p>
              <button
